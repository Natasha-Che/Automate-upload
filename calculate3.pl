...
$head="Browser Name\t"."Number of Requests\t"." %/ Total Requests\t"."Cumulative %/Total Requests\t"."Number of Impressions\t"." %/ Total Impressions\t"."Cumulative\
 %/Total Impressions"."\t"."Number of Revenue\t"." %/ Total Revenue\t"."Cumulative %/Total Revenue"."\n";
...
open(FILE,"tq_browser_distribution1.xls");
while (<FILE>) {
    $line=$_;
    chomp $line;
    (@a) = split /\t/, $line;
